"""
Django settings for FinCorp project.
...
SECRET_KEY = 'django-insecure-ww5@$3(dy9@8mwea#_mfo)i8^8ca$0fkhs@cc(7sv^5w65m3k6'
...
WSGI_APPLICATION = 'FinCorp.wsgi.application'
